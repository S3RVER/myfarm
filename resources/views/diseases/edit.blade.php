@extends('layouts.app', ['title' => 'ویرایش محصول - بیماری های عمومی', 'heading' => 'مطالب عمومی بیماری ها'])
@section('content')
        ...
        <div class="col-sm-12">
            <div class="panel panel-default card-view">
                <div class="panel-heading">
                    <div class="pull-left">
                        <h6 class="panel-title txt-dark">ویرایش محصول - بیماری های عمومی</h6>
                    </div>
                ...
                <div class="panel-wrapper">
                    <div class="panel-body">
                        <div class="form-wrap">
                        {{Form::open(['route' => ['diseases.update', $data->id], 'method' => 'put', 'class' => 'form-horizontal'])}}
                            <div class="col-sm-6">
        ...
        <div class="col-sm-12">
            <div class="panel panel-default card-view">
                ...
                <div class="panel-wrapper">
                    <div class="panel-body">
                        <div class="form-wrap">
                            {{Form::open(['route' => ['diseases.destroy', $data->id], 'method' => 'delete'])}}
